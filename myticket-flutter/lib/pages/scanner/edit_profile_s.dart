...
class EditProfile_sPage extends StatefulWidget {
  @override
  _EditProfile_sPageState createState() => _EditProfile_sPageState();
}

class _EditProfile_sPageState extends State<EditProfile_sPage> {
  TextEditingController _usernameController = TextEditingController(text: "smcdavid");
  TextEditingController _emailController = TextEditingController(text: "lancifrake@gmail.com");
